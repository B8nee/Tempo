...
class Menu extends Phaser.Scene {
    ...
    create() {
        ...
        }).on("pointerover", () => this.play.setTint(0xb2df28)).on("pointerout", () => this.play.setTint(0xffffff));
        ...
        }).on("pointerover", () => this.commands.setTint(0xb2df28)).on("pointerout", () => this.commands.setTint(0xffffff));
        ...
        }).on("pointerover", () => this.credits.setTint(0xb2df28)).on("pointerout", () => this.credits.setTint(0xffffff));
    }
}
