...
class Menu extends Phaser.Scene {
    ...
    create() {
        ...
        this.play = this.add.bitmapText(this.game.canvas.width/2 - 63, this.game.canvas.height/2 + 40, "arcade", "PLAY").setInteractive().on("pointerdown", () => this.scene.start("CharacterSelection")).on("pointerover", () => this.play.setTint(0xb2df28)).on("pointerout", () => this.play.setTint(0xffffff));
